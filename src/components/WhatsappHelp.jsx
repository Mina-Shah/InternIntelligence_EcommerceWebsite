...
const WhatsAppHelp = () => {
  ...
  return (
    <a
      ...
      className="flex items-center gap-2 bg-[#25D366] px-3 py-1.5 md:px-5 md:py-2 rounded-full font-bold text-xs md:text-sm hover:bg-[#128C7E] transition-all shadow-md active:scale-90"
    >
      <svg
        className="w-4 h-4 md:w-5 md:h-5 fill-current text-white"
        viewBox="0 0 24 24"
      >
